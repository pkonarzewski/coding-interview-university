...
- [x] [Harvard CS50 - Asymptotic Notation (video)](https://www.youtube.com/watch?v=iOq5kSKqeR4) # szybkie wprowadzenie, bardzo ogólne
- [x] [Big O Notations (general quick tutorial) (video)](https://www.youtube.com/watch?v=V6mKVRU1evU) # Takie tam pokazanie najpopularniejszych (nie wszystkich) złożoności
